import my_lib
 ...
 # Example usage
input_files_directory = "/scratch/alejandro/tutorial/scan5/"  # Replace with your input file's path
output_file = "/home/alejandro/tutorial/scan5/scan_pes.dat"  # Replace with your output file's path
