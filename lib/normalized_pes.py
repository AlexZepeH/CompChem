...
if __name__ == '__main__':
    ...
    isomer1_data[0] = isomer1_data[0]/100
    isomer2_data[0] = isomer2_data[0]/100
    print(isomer1_data)
    print(isomer2_data)
    ...
    my_lib.save_adiab_coeffs(i2_popt_v1,i2_poptv2,'/home/alejandro/tutorial/scan5/adiab_coeff_i2n.dat')
    ...
    my_lib.save_adiab_coeffs(i1_popt_v1,i1_poptv2,'/home/alejandro/tutorial/scan5/adiab_coeff_i1n.dat')
   
    diab_coeffs=np.loadtxt('/home/alejandro/tutorial/scan5/coeff_diab.dat').T
    data_d1 = my_lib.modeling(i1_data_g0[0],my_lib.poly_model,np.flip(diab_coeffs[0]))
    data_d2 = my_lib.modeling(i1_data_g0[0],my_lib.poly_model,np.flip(diab_coeffs[1]))
    data_coupling = my_lib.modeling(i1_data_g0[0],my_lib.poly_model,np.flip(diab_coeffs[2]))

    diab_coeffs_2=np.loadtxt('/home/alejandro/tutorial/scan5/coeff_diab_i2.dat').T
    i2_data_d1 = my_lib.modeling(i2_data_g0[0],my_lib.poly_model,np.flip(diab_coeffs_2[0]))
    i2_data_d2 = my_lib.modeling(i2_data_g0[0],my_lib.poly_model,np.flip(diab_coeffs_2[1]))
    i2_data_coupling = my_lib.modeling(i2_data_g0[0],my_lib.poly_model,np.flip(diab_coeffs_2[2]))
    ...
    plt.plot(i2_data_coupling[0], i2_data_coupling[1], color='purple', label='d coupling')
    plt.plot(i2_data_d1[0], i2_data_d1[1], color='yellow', label='d1')
    plt.plot(i2_data_d2[0], i2_data_d2[1], color='black', label='d2')
